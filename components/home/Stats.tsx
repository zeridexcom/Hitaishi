...
export function Stats() {
  ...
  const statsData = [
    { value: 12, suffix: "+", label: t("labels.countriesCovered") },
    { value: 5, suffix: "", label: t("labels.visaTypes") },
    { value: 500, suffix: "+", label: t("labels.successfulStudents") },
    { value: 10, suffix: "+", label: t("labels.expertConsultants") },
  ];
